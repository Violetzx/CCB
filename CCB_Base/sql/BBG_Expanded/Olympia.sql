...
INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId)
    SELECT 'BBG_MODIFIER_OLYMPIA_SUZ_' || LeaderType, 'MODIFIER_UNIT_ADJUST_PROPERTY', 'BBG_PLAYER_ATTACKING_IS_SUZERAIN_OF_' || LeaderType || '_REQUIREMENTS'
    FROM Leaders
...
INSERT INTO ModifierArguments(ModifierId, Name, Value)
    ...
    WHERE InheritFrom IN
        ...
        'LEADER_MINOR_CIV_RELIGIOUS', 'LEADER_MINOR_CIV_SCIENTIFIC', 'LEADER_MINOR_CIV_TRADE')
UNION
    SELECT 'BBG_MODIFIER_OLYMPIA_SUZ_' || LeaderType, 'Key', 'MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH'
    FROM Leaders
    WHERE InheritFrom IN
        ('LEADER_MINOR_CIV_CULTURAL', 'LEADER_MINOR_CIV_INDUSTRIAL', 'LEADER_MINOR_CIV_MILITARISTIC',
        'LEADER_MINOR_CIV_RELIGIOUS', 'LEADER_MINOR_CIV_SCIENTIFIC', 'LEADER_MINOR_CIV_TRADE');
...
VALUES ( 'BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY', 'MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH');
INSERT OR IGNORE INTO Modifiers(ModifierId,ModifierType)
VALUES ( 'MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH' );
INSERT OR IGNORE INTO ModifierArguments(ModifierId,Name,Value)
VALUES ( 'MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH', 'Key','MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH'),
       ( 'MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH', 'Max',3);
INSERT OR IGNORE INTO ModifierStrings(ModifierId,Context,Text)
VALUES ( 'MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH', 'Preview','LOC_MODIFIER_BBG_OLYMPIA_MELEE_HEAVY_CS_PER_SUZ_ABILITY_UNIT_STRENGTH_DESC');
