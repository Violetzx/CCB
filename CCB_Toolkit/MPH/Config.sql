...
-- UPDATE Parameters SET DefaultValue = "SETTINGS_DIPLOMACYRIBBON_NORM" WHERE ParameterId = "SETTINGS_DIPLOMACYRIBBON_TPT";
UPDATE Parameters SET DefaultValue = "0" WHERE ParameterId = "NEW_HOTKEYS";