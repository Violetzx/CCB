-- 美国
-- !Civilization
-- start bias to plain and grass mountain
...
-- Film Studios tourism bonus reduced from 100% to 530%
UPDATE ModifierArguments SET Value='30' WHERE ModifierId='FILMSTUDIO_ENHANCEDLATETOURISM' AND Name='Modifier';
